...
public class AdvancedHopperContainer extends Container
{
	private final IInventory inventory;

	public AdvancedHopperContainer(InventoryPlayer player, IInventory inventory)
	{
		...
		{
			this.addSlotToContainer(new Slot(inventory, i, 44 + (i % 6) * 18, 7 + (18 * (i / 5))));
		}
