...
public class SoulEssanceContainer extends Item
{
	...
	public SoulEssanceContainer(String type)
	{
		...
		this.setTextureName("turkeyutil:soul_Essence_Container_" + type);
		this.setUnlocalizedName("soul_Essence_Container_" + type);
	...
	{
		list.add("Stores essence and once full (100 essence) will allow the container to spawn random mob");
		list.add("Note, spawning this item in and not crafting it currently does not work.");
	}
}