...
public class EntitySlowAIArrowAttack extends EntityAIBase
{
    ...
    public EntitySlowAIArrowAttack(IRangedAttackMob p_i1649_1_, double p_i1649_2_, int p_i1649_4_, float p_i1649_5_)
    {
        this(p_i1649_1_, p_i1649_2_, p_i1649_4_, p_i1649_4_, p_i1649_5_);
    }

    public EntitySlowAIArrowAttack(IRangedAttackMob p_i1650_1_, double p_i1650_2_, int p_i1650_4_, int p_i1650_5_, float p_i1650_6_)
    {
    ...
    public void updateTask()
    {
        ...
        if (--this.rangedAttackTime == 0)
        {
            ...
            this.rangedAttackTime = (MathHelper.floor_float(f * (float)(this.maxRangedAttackTime - this.field_96561_g) + (float)this.field_96561_g))*3;
        }
