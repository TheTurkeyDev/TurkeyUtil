...
public class ModelPoisonSkeleton extends ModelZombie
{

    public ModelPoisonSkeleton()
    {
        this(0.0F);
    }

    public ModelPoisonSkeleton(float p_i1156_1_)
    {
    ...
    {
        this.aimedBow = ((EntityPoisonSkeleton)p_78086_1_).getSkeletonType() == 1;
