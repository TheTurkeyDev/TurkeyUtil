...
public class ModelDamageSkeleton extends ModelZombie
{

    public ModelDamageSkeleton()
    {
        this(0.0F);
    }

    public ModelDamageSkeleton(float p_i1156_1_)
    {
    ...
    {
        this.aimedBow = ((EntityDamageSkeleton)p_78086_1_).getSkeletonType() == 1;
