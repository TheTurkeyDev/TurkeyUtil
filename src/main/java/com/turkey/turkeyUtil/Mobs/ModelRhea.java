...
public class ModelRhea extends ModelBase
{
	...
	{
		EntityRhea entityreah = (EntityRhea) p_78086_1_;

		if(entityreah.isAngry())
		{
		...
		this.wolfHeadMain.rotateAngleZ = entityreah.getInterestedAngle(p_78086_4_) + entityreah.getShakeAngle(p_78086_4_, 0.0F);
		this.wolfMane.rotateAngleZ = entityreah.getShakeAngle(p_78086_4_, -0.08F);
		this.wolfBody.rotateAngleZ = entityreah.getShakeAngle(p_78086_4_, -0.16F);
		this.wolfTail.rotateAngleZ = entityreah.getShakeAngle(p_78086_4_, -0.2F);
	}
