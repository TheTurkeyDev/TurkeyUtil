...
{
	private EntitySlowAIArrowAttack aiArrowAttack = new EntitySlowAIArrowAttack(this, 1.0D, 20, 60, 15.0F);

	public EntityDamageSkeleton(World p_i1741_1_)
	{
		super(p_i1741_1_);
	...
	public void attackEntityWithRangedAttack(EntityLivingBase p_82196_1_, float p_82196_2_)
	{
		...
		EntityPotion potion = new EntityPotion(worldObj, entityarrow.posX, entityarrow.posY, entityarrow.posZ, new ItemStack(Items.potionitem, 1, 16396));
