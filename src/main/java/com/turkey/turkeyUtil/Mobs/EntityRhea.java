...
public class EntityRhea extends EntityTameable
{
	...
	public EntityRhea(World p_i1696_1_)
	{
		super(p_i1696_1_);
		...
		if (this.isTamed())
		{
			if (itemstack != null)
			{
				if (itemstack.getItem() instanceof ItemFood)
				{
					...
					if (itemfood.equals(UtilFood.dangerDog) && this.dataWatcher.getWatchableObjectFloat(18) < 20.0F)
					{
	...
	public EntityRhea createChild(EntityAgeable p_90011_1_)
	{
		EntityRhea entitywolf = new EntityRhea(this.worldObj);
	...
	public boolean canMateWith(EntityAnimal p_70878_1_)
	{
		...
		else if (!(p_70878_1_ instanceof EntityRhea))
		{
			return false;
		}
		else
		{
			EntityRhea entitywolf = (EntityRhea)p_70878_1_;
	...
	public boolean func_142018_a(EntityLivingBase p_142018_1_, EntityLivingBase p_142018_2_)
	{
		...
		{
			if (p_142018_1_ instanceof EntityRhea)
			{
				EntityRhea entitywolf = (EntityRhea)p_142018_1_;
